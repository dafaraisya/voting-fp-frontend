        ...
        <b-row>
            <b-col class="mb-3" lg="12">
                <div class="container bg-success p-4 text-left rounded-lg shadow">
                    <h3 class="text-white"> Selamat datang di Dashboard PEMIRA FP UNS 2020! </h3>
                </div>
            </b-col>
            <b-col lg="3">
            ...
            <b-col lg="3">
                <div class="container bg-white p-3 text-center rounded-lg shadow">
                    ...
                    <h2>{{ outline.participantVoted }}</h2>
                </div>
            </b-col>
        </b-row>
    </b-container>
...
export default {
    ...
    methods:{
        getOutline() {
            axios
                .get("http://52.152.228.107:3000/api/v1/outline")
