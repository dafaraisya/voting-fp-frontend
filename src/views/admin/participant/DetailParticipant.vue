            ...
            <b-col lg="6">
                <div class="container bg-white mt-2 p-3 shadow-sm rounded">
                    <div id="pemira-card" class="p-3 bg-white" style="border: 2px inset #aaa">
                        <img src="@/assets/logo kpr3.png" style="height:50px; width:50px;"/>
    ...
    methods:{
        del(){
            Swal.fire({
                ...
                if (result.isConfirmed) {            
                    axios
                        .delete("http://52.152.228.107:3000/api/v1/participant/"+this.$route.params.id)
                        .then(() => {
                            Swal.fire({
                                icon: 'success',
        ...
        send(to, name, nim, id) {
            ...
            .then(function (image) {
                ...
                axios
                    .post("http://52.152.228.107:3000/api/v1/mail/", data)
                    .then(() => {
                        Swal.fire({
                            icon: 'success',
